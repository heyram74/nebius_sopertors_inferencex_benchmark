...
1. Provision Nebuis soperator cluster by following the steps [here]
...
3. SSH to the login node and clone [InferenceX] into /home/InferenceX
4. Clone [this repo's scripts] folder into into /home/scripts
